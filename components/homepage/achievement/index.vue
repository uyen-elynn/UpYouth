<template>
  <div class="mx-auto max-w-full bg-blue-50 py-8 my-8">
    <UContainer>
      <div class="flex flex-col justify-center items-center gap-8">
        <h1 class="text-6xl font-bold">Our numbers speak</h1>
        <p class="mb-8">
    ...
    <UContainer
      class="grid grid-cols-2 gap-x-8 gap-y-4 lg:grid-cols-4"
    ...
    >
      <div v-for="achievement in achievementList" :key="achievement.id">
        <div class="flex flex-col justify-center items-center gap-2">
          ...
          <p class="text-lg text-center">{{ achievement.content }}</p>
        </div>
      </div>
    </UContainer>
  </div>

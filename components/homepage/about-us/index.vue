  ...
  <div>
    ...
    <UContainer :ui="{ constrained: 'lg:max-w-7xl max-w-xl' }">
      <div v-for="item in aboutUsList" :key="item.id">
        <div
          class="lg:flex lg:items-center lg:justify-between lg:gap-16 lg:text-left text-center"
          :class="item.id % 2 === 0 ? 'my-16 flex-row' : 'flex-row-reverse'"
        >
          ...
          <div class="mt-16 flex flex-col gap-2 lg:mt-0 lg:gap-8">
            ...
            <p class="leading-6 sm:text-base text-sm">{{ item.content }}</p>
